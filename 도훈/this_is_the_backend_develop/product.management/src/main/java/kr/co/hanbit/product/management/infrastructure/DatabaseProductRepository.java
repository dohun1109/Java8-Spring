...
public class DatabaseProductRepository implements ProductRepository {
    ...
    public Product add(Product product) {
        ...
        SqlParameterSource namedParameter = new BeanPropertySqlParameterSource(product);    //객체 매핑
    ...
    public Product findById(Long id) {
        SqlParameterSource namedParameter = new MapSqlParameterSource("id", id); //Map 형태로 Key-Value 형태를 매핑할 수 있다.
        ...
        try {
            product = namedParameterJdbcTemplate.queryForObject(
                    ...
                    namedParameter,
                    new BeanPropertyRowMapper<>(Product.class)  //Product 인스턴스로 변환해서 return 해준다
            );
